...
function Meta({
  title = 'Cody Cooper | CTF guy', // page title
  name = 'Cody Cooper CTF writeups', // site name
  description = 'A website for me to host all my CTF writeups and maybe some other random stuff if I feel like it.', // page description
