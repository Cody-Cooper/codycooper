...
Follow the guide I've written [here](/posts/unraid-dynamic-dns) to set up Dynamic DNS, allowing your server to stay online and public facing even if your public IP address changes. This is very important!
