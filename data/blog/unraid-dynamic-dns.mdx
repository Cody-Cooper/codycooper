---
title: Setting up Dynamic DNS on Namecheap using ddclient on an Unraid server
date: '2023-03-27'
tags: ['unraid', 'home-lab']
draft: false
summary: Dynamic DNS allows you to update your IP address automatically when it changes, so you can access your domain name from anywhere. This is useful for a ton of different reasons, and will tie in very well to Nginx and allow you to set subdomain based proxies to whatever Unraid app you would like.
images: []
layout: PostLayout
canonicalUrl:
---
...
![namecheap dynamic DNS settings](/static/images/ddns/namecheap-dynamic-dns-settings.png)
...
![Screenshot of the ddclient template page on the unraid app store](/static/images/ddns/ddclient-app-page.png)
...
![ddclient conf settings](/static/images/ddns/ddclient-conf.png)
