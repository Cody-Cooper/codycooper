...
date: '2023-04-10'
tags: ['unraid', 'home-lab']
draft: false
summary: Umami is a simple and lightweight web analytics tool that respects user privacy and does not use cookies, making it a great alternative to third-party services like Google Analytics. Let me help you install Umami to your Unraid server using Docker Compose and Nginx - You won't be dissapointed!
images: []
layout: PostLayout
canonicalUrl:
---
...
- Docker Compose Manager
  ...
  ![Screenshot of the Docker Compose Manager template page on the unraid app store](/static/images/umami/docker-compose-manager-app-page.png)
...
- Nginx
  ...
  ![Screenshot of the Nginx Proxy Manager Official template page on the unraid app store](/static/images/umami/nginx-proxy-manager-official-app-page.png)
...
![Docker compose manager, stack settings options](/static/images/umami/umami-compose-options.png)
...
![Nginx proxy host details tab setup for Umami](/static/images/umami/nginx-proxy-host-details-tab.png)
...
![Umami settings, location of the Get tracking code option](/static/images/umami/umami-get-tracking-code.png)
