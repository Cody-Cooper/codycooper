...
![overview of the notification agents screen on tautulli](/static/images/kill_stream/notification-agents-screen.png)
...
<br />
![screenshot of how you should be setting up your configuration tab for kill_stream.py](/static/images/kill_stream/notification-agent-configuration-tab.png)

In the Triggers tab, check Playback Start and Transcode Decision Change.

![screenshot of how you should be setting up your triggers tab for kill_stream.py](/static/images/kill_stream/notification-agent-triggers-tab.png)
...
kill_stream.py](/static/images/kill_stream/notification-agent-conditions-tab.png)
...
kill_stream.py](/static/images/kill_stream/notification-agent-arguments-tab.png)
...
webhooks in tautulli](/static/images/kill_stream/webhook-configuration.png)
...
![How the kill message should look for the end user on plex after triggering kill_stream.py](/static/images/kill_stream/kill-message-plex.png)

You should also receive a notification in discord/slack with the message that you specified in the script arguments

![How the rich discord notification should look on plex after triggering kill_stream.py](/static/images/kill_stream/kill-message-discord.png)
